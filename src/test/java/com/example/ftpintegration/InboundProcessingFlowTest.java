...
public class InboundProcessingFlowTest {
    ...
    public void processTwoFiles() throws Exception {
        ...
        verify(processor, times(1)).processFile(content1);
        verify(processor, times(1)).processFile(content2);
    ...
    public void processTwoFilesOneErrorOnProcess() throws Exception {
        ...
        doThrow(IOException.class).when(processor).processFile(content1);
